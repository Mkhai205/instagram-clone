...
function LoginPage() {
    return (
        <div className="space-y-6">
            {/* Main Login Card */}
            <Card
                className="border border-white/20 dark:border-gray-600/30 shadow-2xl 
                bg-white/95 dark:bg-slate-900/85 backdrop-blur-xl backdrop-saturate-150"
            >
                <CardHeader className="text-center pb-6">
                    <div className="flex justify-center mb-6">
                        <div
                            className="p-4 rounded-3xl bg-gradient-to-r from-purple-500 via-pink-500 
                            to-orange-500 shadow-2xl transform hover:scale-105 transition-all duration-300"
                        >
                ...
                <CardContent className="px-8 pb-8">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                            By continuing, you agree to Instagram&apos;s Terms of Service and
                            Privacy Policy
                        </p>
                    </div>
                </CardContent>
